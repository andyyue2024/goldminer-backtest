...
def on_order_status(context, order):
    if order.status != OrderStatus_Filled:
        print('on_order_status, now:', context.now, ', info:', order)
    update_status(context)
...
if __name__ == '__main__':
    ...
    run(strategy_id='95eadb57-f0cb-11ef-b05b-80304917db79',
        ...
        backtest_start_time='2024-12-31 09:31:00',
        backtest_end_time='2025-01-31 15:00:00',
        backtest_adjust=ADJUST_NONE,
        backtest_initial_cash=31000,
